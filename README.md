...
1. Get a free API Key for Alpha Vantage, News API, SendGrid at [https://www.alphavantage.co/](https://www.alphavantage.co/), [https://newsapi.org](https://newsapi.org/) and [https://interactive.twilio.com/email-brand-signup-sales](https://interactive.twilio.com/email-brand-signup-sales), respectively.
